...
export function createServerEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    cursorLocalHistoryDryRun: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:server:cursor-local-history-dry-run",
      tag: WS_METHODS.serverCursorLocalHistoryDryRun,
    }),
    cursorLocalHistoryImport: createEnvironmentRpcCommand(runtime, {
